...
class Auth:
    ...
    def get_password_hash(self, password: str):
        ...
        :param password: str: Pass the password that will be hashed
    ...
    async def create_refresh_token(self, data: dict, expires_delta: Optional[float] = None):
        ...
        :param self: Represent the instance of the class
        :param data: dict: Pass the user data that will be encoded in the jwt
        :param expires_delta: Optional[float]: Set the time that a token is valid for
    ...
    async def decode_refresh_token(self, refresh_token: str):
        ...
        :param refresh_token: str: Pass in the refresh token that is sent with the request
    ...
    async def get_current_user(self, token: str = Depends(oauth2_scheme), db: Session = Depends(get_db)):
        ...
        :param self: Represent the instance of the class
        :param token: str: Get the token from the header of our request
